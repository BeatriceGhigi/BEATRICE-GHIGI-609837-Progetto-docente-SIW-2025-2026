...
public class TorneoController {
	...
	public String show(@PathVariable("id") Long id, Model model) {
		...
		model.addAttribute("torneo", torneo); // metto a disposizione del componente che genera l'html, il componente
												// che mette a disposizione l'html puù generare quest'oggetto
